...
int main ()
{
    ...
    printf("20 - Obter produto de 2 matrizes \n");
    printf("0  - Sair \n");
...
void method20()
{
    ...
    int multiplicarMatriz (int matriz1[2][5], int matriz2[2][5]);

    total = multiplicarMatriz(matriz, matriz2);

    printf("Produto das duas matrizes = %d \n", total);
