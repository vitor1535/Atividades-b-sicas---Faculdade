...
/** para ser executavel devera' haver uma acao principal (main) como ponto de partida. */
    int main ( int argc, char* argv [ ] )         // <- parametros opcionais, neste caso
    {
     ...
     //           em ponto flutuante 32-bits no padr�o IEEE 754
        float  aFloat = 234.5f;           // usar a letra 'f' e' obrigatorio

     // double  - real de precisao dupla,
     //           em ponto flutuante 64-bits no padr�o IEEE 754
...
// fim do exemplo AED1
/*
Apos compilar o arquivo aed1, o windows denunciou um virus ameaçando o sistema,
entao nao consegui abrir o executavel
*/
