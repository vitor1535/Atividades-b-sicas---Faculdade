    ...
    while (x !=0)
{
    ...
    printf("Exemplo 18 = Mostrar valores pares da sequencia de Fibonacci, gravados em txt \n");
    printf("Exemplo 19 = Contar caracteres maiuscular de um arquivo txt, gravado em txt \n");
    printf("Exemplo 20 = Contar digitos maiores ou iguais a 7 de um arquivo txt, gravado em txt \n");
    printf("Exemplo 0  = SAIR \n");
...
void exemplo0719 ()
{
    ...
    printf("Insira algumas palavras \n");
    scanf("%s", &caracteres);
    printf("%s", caracteres);

    FILE *file;
    file = fopen( "Cadeia de caracteres.txt", "w");
    fprintf(file, "%c", caracteres);
    fclose(file);


    FILE *file2;
    file2 = fopen ("RESULTADO09.txt", "w");
