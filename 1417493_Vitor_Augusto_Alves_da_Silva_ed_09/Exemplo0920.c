...
{   
    ...
    printf("15 - Mostrar valores abaixo e na diagonal principal de uma matriz \n");
    printf("16 - Mostrar valores acima e na diagonal principal de uma matriz \n");
    printf("17 - Mostrar valores abaixo e na diagonal secundaria de uma matriz \n");
    printf("18 - Mostrar valores acima e na diagonal secundaria de uma matriz \n");
    printf("19 - Testa se ha algum 0 abaixo da diagonal principal de uma matriz \n");
    printf("20 - Testa se ha algum 0 acima da diagonal principal de uma matriz \n");
